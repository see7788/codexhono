...
export default function CodexTplPage() {
  ...
  const sourceChange = appStore(state => state.tpl.sourceChange);
  const sourceLoad = appStore(state => state.tpl.sourceLoad);
  const sourceSave = appStore(state => state.tpl.sourceSave);
  const sourceSaveStatus = appStore(state => state.tpl.sourceSaveStatus);
  const sourceSaveStatusChange = appStore(state => state.tpl.sourceSaveStatusChange);
  const sourceSaveTick = appStore(state => state.tpl.sourceSaveTick);
  const sourceSaveTickNext = appStore(state => state.tpl.sourceSaveTickNext);
  const targetDelete = appStore(state => state.tpl.targetDelete);
  const targetPut = appStore(state => state.tpl.targetPut);
